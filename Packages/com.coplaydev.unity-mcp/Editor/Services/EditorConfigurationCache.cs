...
namespace MCPForUnity.Editor.Services
{
    ...
    public class EditorConfigurationCache
    {
        ...
        /// Default: true
        /// </summary>
        public bool UseHttpTransport => SkybridgeProjectMcp.Enabled || _useHttpTransport;
        ...
        /// Default: empty string
        /// </summary>
        public string HttpTransportScope => SkybridgeProjectMcp.Enabled ? "local" : _httpTransportScope;
