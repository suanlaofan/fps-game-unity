...
public class AutomaticGunScriptLPFP : MonoBehaviour {
	...
	// Read-only values used by the Level 0 in-game HUD.
	public int CurrentAmmo { get { return currentAmmo; } }
	public int MaxAmmo { get { return ammo; } }
	public string DisplayWeaponName { get { return string.IsNullOrEmpty(weaponName) ? "ASSAULT RIFLE" : weaponName; } }
